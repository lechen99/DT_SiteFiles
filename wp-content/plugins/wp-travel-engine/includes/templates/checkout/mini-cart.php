...
?>
    <div class="wpte-bf-summary-wrap">
		...
		foreach( $cart_items as $key => $cart_item ) : ?>
            <div class="wpte-bf-trip-name-wrap">
                ...
                <span class="wpte-bf-trip-date"><?php echo esc_html( sprintf( __( 'Check-In Date: %1$s', 'wp-travel-engine' ), date_i18n( $date_format, strtotime( $cart_item['trip_date'] ) ) ) ); ?></span>
            </div>
			...
			<!-- ./ Extra Services -->
                ...
                <tfoot>
                    <!--<tr>-->
                        <!-- The code below has been commented to remove the total price from the Booking Summary, if it is needed you can uncomment to enable it. ~ Software Stars -->
                        <!--<tr>-->
                        <!--    <td colspan="2">-->
    ...
    ?>
        <div class="wpte-bf-total-price">
            <span class="wpte-bf-total-txt"><?php esc_html_e( 'Total Amount :', 'wp-travel-engine' ); ?></span>
            <!--<span class="wpte-price">-->
            <?php echo wp_travel_engine_get_formated_price_with_currency_code_symbol( $payable_now, null, true ); ?>
            <p style = "font-size: 12px"><b>** Note: You will be contacted by an agent regarding payment</b></p>
            </span>
        </div>
