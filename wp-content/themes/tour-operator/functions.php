    ...
    <div class="footer-b">
        <div class="site-info">
            <?php
                ...
                echo esc_html__( '| All Rights Reserved.', 'tour-operator' );
        ...
        <!-- code for the terms and privacy policy is below -->
        
        <div class="policies-foot">
            <a href="/terms-and-conditions" rel="nofollow" target="_blank">Terms & Conditions</a>&nbsp;&nbsp;
